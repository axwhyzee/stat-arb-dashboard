...
class fxcmpy(object):
    ...
    def create_oco_order(self, symbol, is_buy, is_buy2, amount, is_in_pips,
        ...
        try:
            ...
            if trailing_stop_step2 != 0.1:
                trailing_stop_step2 = int(trailing_stop_step2)
        except:
...
'%s', 'asks', 'bids'."
    ...
    def __handle_request__(self, method='', params=None, protocol='get'):
        ...
        self.logger.info('Socket id: %s' % self.socket.get_sid())
        ...
        self.socket_id = self.socket.get_sid()
